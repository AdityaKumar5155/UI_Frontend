...
function sendCheckInMail(data) {
    ...
    let mailOptions = {
        ...
        to: data.email,
        subject: `${data.name} You've Checked In - HackNest`,
        html: `Dear ${data.name},<br><br>
           ...
           Nidhi Satyapriya: nidhi.2201186cs@iiitbh.ac.in<br>
           Souwik Maity: aditya.2201001cs@iiitbh.ac.in<br>
           Somesh Mishra: somesh.2201019cs@iiitbh.ac.in<br><br>
           Satyam Raj: satyam.2201014cs@iiitbh.ac.in<br><br>
           Aditya Kumar: aditya.2201001cs@iiitbh.ac.in<br><br>
           Thank you for choosing Devnovate Eventron!<br><br>
           Best regards,<br>
           The Devnovate Team`,
    };
